...
<head>
    ...
    <title>MARINA FOTOGRAFIA- Contáctenos</title>
</head>

<body>
    <!-- Cabecera -->
    <header class="header">
        <img src="../img/logo/portada1.png" alt="Freddy Chiken" class="logo">
        <!-- Navegación -->
        <nav>
    ...
    <div class="main">
        <section class="servicio-al-cliente">
            <div class="content">
                ...
                <br>
                    <img  src="../img/Nosotros/Diseño sin título (7).jpg" alt="Chicken" class="img-Chiken">
